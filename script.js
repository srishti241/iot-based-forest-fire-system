function myFunction() {
    ...
    const url='https://iot-based-forest-fire-monitor-default-rtdb.asia-southeast1.firebasedatabase.app/Flamesensor_data.json';
...
function myFunction2() {
    ...
    //console.log(selectedDate);
    const Http = new XMLHttpRequest();
    const url='https://iot-based-forest-fire-monitor-default-rtdb.asia-southeast1.firebasedatabase.app/Gassensor_data.json';
